...
import { getEventChatRef } from '../../../firestore/firebaseService';
import { createDataTree } from '../../../common/util/util';
				...
				<Comment.Group>
					{createDataTree(comments).map((comment) => (
						<Comment key={comment.id}>
							<Comment.Avatar
								src={comment.photoURL || require('../../../../assets/images/user.png')}
							/>
							<Comment.Content>
								...
								<Comment.Group>
									{comment.childNodes.reverse().map((child) => (
										<Comment key={child.id}>
											<Comment.Avatar
												src={child.photoURL || require('../../../../assets/images/user.png')}
											/>
											<Comment.Content>
