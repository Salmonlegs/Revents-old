...
import { Grid, Segment, Item, Statistic, Divider, Reveal, Button, Header } from 'semantic-ui-react';
...
import { CLEAR_FOLLOWING } from './profileConstants';
...
export default function ProfileHeader({ profile, isCurrentUser }) {
	...
	async function handleFollowUser() {
		...
		try {
			...
			console.log('handleFollowUserERROR', error);
			toast.error(error.message);
		} finally {
			setLoading(false);
		}
					...
					<Item.Group>
						<Item>
							<Item.Image
								avatar
								size='small'
								src={profile.photoURL || require('../../../assets/images/user.png')}
							/>
